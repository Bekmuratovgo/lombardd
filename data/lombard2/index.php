...
?>
	...
	<div class="rates">
		...
		<div class="text-notice">Бесплатный способ (то есть без комиссии за перевод денежных средств в пользу ООО Первый ювелирный ломбард") исполнения обязательств заемщика по  возврату суммы займа и процентов за пользование суммой займа: Заёмщик исполняет обязательства путём внесения наличных денежных средств по месту заключения договора, либо по безналичному расчету.</div>
	</div>
	<!--end rates-->
	...
	<div class="block-reestr">
		<div class="left">
			Внесены в реестр ломбардов ЦБ РФ 13.02.2014
		</div>
		<div class="right">
			<img src="/tpl/images/qr/qr-lombard_01.gif" alt="" />
		</div>
	</div>
