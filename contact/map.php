	...
	<div class="office__block office__block_left js-fixed-left">
		<div class="tabs tabs_office">
			...
			<div class="tabs__content" tabindex="0"
				...
				<div class="office__map" id="js-office-map" data-center="55.7722533, 37.5714684" data-zoom="13"></div>
			</div>
	...
	<div class="office__block office__block_right js-office-right">
		...
		<div class="tabs tabs_map">
			<ul class="tabs__links">
				<li>
					<a href="#js-tabs__item-4" class="tabs__link  js-tabs__link active" data-title="Отделения ломбардов Первый ювелирный в Москве" data-icon="icon_star"><span class="icon icon_star"></span><span>В Москве</span></a>
				</li>
			</ul>
			<div class="tabs__content">
				<div class="tabs__item js-tabs__item active" id="js-tabs__item-4">
		...
		<div class="office__item">
			<div class="office__left">
				...
				<ul class="office__list">
					<li class="office__list-item">
						<a href="tel:+74991105054">+7(499) 110-50-54</a>
					</li>
					<li class="office__list-item">
			...
			<div class="office__right">
				<ul class="office__list office__list_red">
					<li class="office__list-item">9:00 - 21:00</li>
					<li class="office__list-item">Без выходных</li>
				</ul>
			</div>
		</div>
		<div class="office__item">
			<div class="office__left">
				...
				<ul class="office__list">
					<li class="office__list-item">
						<strong>ООО «Первый ювелирный драгоценные металлы»</strong> <br>
						ОГРН 1167746342609 <br>
						ИНН 7703408540 <br>
						Номер свидетельства о постановке на специальный учет: 017763134
					</li>
