...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"FILTER_PROPERTY_CODE" => array("TYPE","METALL","TRY","SIZE","INSERT","NEWPRODUCT","POPULAR",""),
		...
		"LIST_PROPERTY_CODE" => array("TYPE","METALL","TRY","SIZE","INSERT",""),
		...
		"SEF_FOLDER" => "/catalog/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => Array("compare"=>"compare.php?action=#ACTION_CODE#","element"=>"#SECTION_CODE#/#ELEMENT_CODE#","section"=>"","sections"=>"","smart_filter"=>"#SECTION_CODE#/filter/#SMART_FILTER_PATH#/apply/"),
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
		"SHOW_404" => "N",
